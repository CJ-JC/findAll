        ...
        <>
            <div className="container my-5">
                ...
                <ol>
                    ...
                    <li>
                        Garanties ou compensation : Nos produits sont accompagnés d'une garantie pour garantir la satisfaction du client. Il est important de noter que la durée de la garantie varie pour chaque produit. <br /> Nous vous recommandons fortement de vous référer à la description détaillée du produit sur notre site Web pour obtenir des informations spécifiques concernant la durée de garantie associée à chaque article.
                    </li>
