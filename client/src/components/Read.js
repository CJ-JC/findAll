                ...
                <div className="row">
                    <div className="col-lg-8">
                        <div className="card p-4">
                            <h2>{product.title}</h2>
                            <img src={`https://digital-discount-server-8cnrfax1a-john-does-projects-63a61406.vercel.app//upload/${product.image}`} alt={product.image} style={{ margin: "auto", width: "60%", objectFit: "cover", height: "100%", opacity: ".6" }} />
